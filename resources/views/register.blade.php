...
<body>
    ...
    <div class="p-10 grid justify-items-center">
        <div>
            <form class="grid justify-items-center" action="{{ route('register') }}" method="post">
                @csrf
        ...
        <div class="p-5">
            <p>Already have an account? <a class="text-sky-400 underline" href="{{ route('login') }}">Login</a></p>
        </div>
    </div>
</body>
</html>